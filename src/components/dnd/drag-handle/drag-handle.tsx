...
function DragHandle({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex size-7 shrink-0 cursor-grab touch-none items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground focus-visible:ring-2 focus-visible:ring-foreground/20 focus-visible:outline-none active:cursor-grabbing',
        className,
      )}
      {...attributes}
      {...listeners}
